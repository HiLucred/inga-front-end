...
export default function Home() {
  return (
    <div className="w-full h-full flex flex-col items-center justify-center mt-20">
      ...
      >
        <h1 className="text-8xl sm:text-9xl font-extrabold bg-gradient-to-tr from-blue-600 to-red-600 text-transparent bg-clip-text">
          ING
        </h1>
      ...
      <div
        ...
        style={{
          textShadow: '0 4px 120px #1852e586',
        }}
      >
